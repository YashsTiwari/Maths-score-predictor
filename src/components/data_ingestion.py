...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            os.makedirs(
                os.path.dirname(self.ingestion_config.train_dataset_path), exist_ok=True
            )
            ...
            train_set.tocsv(
                self.ingestion_config.train_dataset_path, index=False, header=True
            )

            test_set.tocsv(
                self.ingestion_config.test_dataset_path, index=False, header=True
            )
